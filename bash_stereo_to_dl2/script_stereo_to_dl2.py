...
def stereo_dl1(obs_id_string, source_name):
    ...
    process[2] = False    # event coincidence for the night
    process[3] = False    # stereo reconstruction
    process[4] = False    # merging the stereo files
    process[5] = True    # converting dl1 to dl2
    ...
    output_dir = f'/fefs/aswg/workspace/juan.jimenez/data/dl2/stereo_raw_dl2_{source_name}'
